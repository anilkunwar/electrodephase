...
def main():
    ...
    with tab4:
            ...
            with st.expander("⚡ Governing Equations", expanded=False):
                ...
                **Flux Models by Kinetics Type:**
                ...
                - **MHC (kinetics_type=2)**:  
                  ...
                  Accounts for reorganization energy (simplified).
        ...
        with col2:
            st.markdown("""
            <div class="card">
            <h4>⚡ Supported Physics</h4>
            <table>
            <tr><td><strong>Kinetics Models</strong></td><td>PNP / BV / MHC</td></tr>
            <tr><td><strong>C-Rate Effects</strong></td><td>Yes</td></tr>
            <tr><td><strong>Electrostatics</strong></td><td>Poisson-coupled</td></tr>
            <tr><td><strong>Phase Separation</strong></td><td>Cahn–Hilliard</td></tr>
            </table>
            </div>
            """, unsafe_allow_html=True)
